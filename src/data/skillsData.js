...
export const SKILLS = {
  ...
  strength: { 
    name: "Strength",
    level: [
      eff.changeAttribute("healthMax", 0.5),
      eff.changeAttribute("staminaMax", 0.5),
    ], 
  },
  constitution: { 
    name: "Constitution",
    level: [
      eff.changeAttribute("healthMax", 1),
    ], 
  },
  agility: { 
    name: "Agility",
    level: [
      eff.changeAttribute("staminaMax", 1),
    ], 
  },
  dexterity: { 
    name: "Dexterity",
  ...
  intelligence: { 
    name: "Intelligence",
    level: [
      eff.changeAttribute("mentalMax", 1),
    ], 
  },
  willpower: { 
    name: "Willpower",
    level: [
      eff.changeAttribute("healthMax", 0.5),
      eff.changeAttribute("mentalMax", 0.5),
    ], 
  },
  wit: { 
    name: "Wit",
